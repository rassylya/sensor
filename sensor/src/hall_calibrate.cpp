...
int main(int argc, char **argv)
{
	...
	string hall_type, mode;
	float speed = 0;
	cout<<"Insert hall type (red, green)"<<endl;
	while (true){
		cin>>hall_type;
		if(hall_type=="red" || hall_type=="green") break;
	} 
	/////
	...
	ofstream myfile;
	ss << "/home/rass/Rassul/hall_data/"<< hall_type <<"_"<< now->tm_mday <<"_"<<now->tm_hour <<":"<<now->tm_min<<"_data.csv";
